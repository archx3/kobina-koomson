...
<!--    <services/>-->
    ...
    <div class="circle-cursor circle-cursor--inner" style="transform: matrix(1, 0, 0, 1, 0, 35); opacity: 1;"></div>
  </div>
</template>
...
export default {
  name      : 'home',
  components: { AboutMe, MyClients, ContactMe, PortfolioGallery, HeaderWrap, SkillsGallery },
  props     : [],
  data () {
    return {
