  ...
  computed: {
    introStrings: function () {
      return [
        ...
        // "<span class='font-weight-light'></span> <br>",
        `<span><span class='font-weight-light'>I'm</span>  <span class='official-name'>${this.getOfficialName}</span></span>`]
    },
    skillsText: function () {
      return [
    ...
    getOfficialName () {
      return toArray(this.officialName).map(char => {
